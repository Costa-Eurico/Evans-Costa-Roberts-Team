...
public class RescueVictimView {
    ...
    private final String QUESTION = "\n"
            ...
            + "\n by lowering him/her to the grownd through the outside of the "
            + "\n outside of the building, using a rope. You will need to determine"
            + "\n the lenght of rope required to lower the victim and away from "
